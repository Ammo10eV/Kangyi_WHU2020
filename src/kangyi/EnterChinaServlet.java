...
public class EnterChinaServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public EnterChinaServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
	 		...
	 		args1=new String[]{"python","C:\\Users\\10128\\DC\\WS\\kangyi\\src\\resources\\Chinamodel_forweb.py",
	 				time1,choose1,time2,choose2,time3,choose3};
