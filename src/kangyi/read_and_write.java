...
public class read_and_write {
    ...
    public static void method_readAndwrite() throws IOException {
        ...
        FileReader fr = new FileReader(new File("C:\\Users\\Thinkpad\\eclipse-workspace\\kangyi\\stacked_area_chart4.html"));//原始文件
        BufferedReader br = new BufferedReader(fr);
        FileWriter fw = new FileWriter(new File("C:\\Users\\Thinkpad\\eclipse-workspace\\kangyi\\WebContent\\infection.jsp"));//新的文件
        String str = null;
        ...
        fw.write("                <span class=\"icon-bar\"></span>\n");
        fw.write("            </button>\n");
        fw.write("            <a href=\"\" class=\"navbar-brand\">战疫助手 >疫情数据</a>\n");
        fw.write("        </div>\n");
        fw.write("        <!--小屏幕导航按钮和logo-->\n");
        fw.write("\n");
        fw.write("        <!--右上角导航-->\n");
        ...
        fw.write("                <li><a href=\"infection.jsp\" target=\"_blank\">疫情数据</a></li>\n");
        fw.write("                <li><a href=\"news.html\" target=\"_blank\">舆情数据</a></li>\n");
        fw.write("                <li><a href=\"EnterChinaServlet?flag=1\" target=\"_blank\">实用版预测</a></li>\n");
